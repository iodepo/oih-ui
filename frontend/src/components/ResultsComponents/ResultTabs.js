...
export default function ResultTabs({
  ...
  return (
    <div id="ResTabs">
      <Tabs
        selectedIndex={tabList.findIndex((tab) => tab.title === searchType)}
      >
                  ...
                  <div
                    className={
                      ...
                      (tab.title === searchType
                        ? "bg-selected rounded-circle bubble-alt"
                        : " primary-bg rounded-circle bubble-alt")
                    }
                  >
                    <span className="text-light-tab">
                      {formatter.format(counts[tab.title] || 0)}
                    </span>
                  </div>
                </div>
                <div
