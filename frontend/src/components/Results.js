            ...
            <div className="row mx-auto">
              <div className="col-12 container mb-3">
                <h6 className="primary-color text-start text-light ps-5 pt-3">
                  {" "}
                  Total results found {resultCount || 0}
                </h6>
              </div>
              <div>
                    ...
                    <div className="">
                      <div className="row">
                        <div className="container col-6">
                          ...
                          />
                          <div>
                            Note: Geometries that are larger than the map
                            display area will not be displayed. <br />
                            Search results corresponding to the map area show
                            below. <br />
                            <span>
                              {zoom <= 3 &&
                                "Zoom in to hover over areas to see the objects associated with them."}
                            </span>
                            <br />
                          </div>
                        </div>
