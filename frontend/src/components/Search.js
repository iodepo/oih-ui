...
export default function Search() {
  ...
  const placeholder = useCallback(() =>
    translationState.translation["Search across our"] + (getPromotedRegion(region) || translationState.translation['Global']) + translationState.translation["Partners"]
          ...
          <div className="col-12 col-md-9 col-sm-11">
            <form
              ...
              <Button
                ...
                <span className="h6">{translationState.translation["Search"]}</span>
              </Button>
            </form>
            {!isResults && (
              <div className="text-light text-start mt-3">
                <span className="p-2 h5">{translationState.translation["Try"]}:</span>
            ...
            {!isResults && (
              <div className="text-light text-end ">
                <a href='#bbc' className='text-light'>{translationState.translation["Browse"]}</a>
              </div>)}
          </div>
        </div>
      </div>
